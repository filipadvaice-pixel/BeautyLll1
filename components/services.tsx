  ...
  return (
    <section id="services" className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Наши <span className="gradient-text">услуги</span></h2>
          <p className="text-white/70 max-w-2xl mx-auto">Профессиональный уход за вашей красотой с использованием современного оборудования</p>
        </motion.div>
        ...
        >
          <button 
            ...
            className="bg-gradient-to-r from-purple-600 to-purple-400 px-8 py-4 rounded-full font-semibold hover:scale-105 transition-transform shadow-lg shadow-purple-500/30"
          >
